...
An AI-powered system for MRI anomaly detection using LangChain, OpenAI GPT-4, and Tavily AI API with interactive image upload capabilities.
...
- **GPT-4 Explanations**: Detailed medical interpretations using OpenAI GPT-4
...
```bash
git clone https://github.com/skkuhg/mri-anomaly-detection-system.git
cd mri-anomaly-detection-system
```
...
5. Update API keys in the notebook:
...
- **`MedicalExplanationGenerator`**: GPT-4 powered medical explanations
...
├── mri_anomaly_detection_system.ipynb  # Main notebook (upload separately)
...
- **OpenAI**: GPT-4 API for medical explanations
